...
const CONTENT = {
  ko: {
    ...
    launch: 'Launch',
    open: '열기',
    eyebrow: 'GitHub-native shared knowledge',
    mindsync: {
      tag: '뇌 레이어 · MindSync',
      title: '데이터를 두번째 뇌로, 두번째 뇌를 워크스페이스로',
      desc: '워드·한글·PPT·PDF 등 다양한 파일을 한 번에 올리면, AI가 의미 단위로 지식 그래프를 자동 생성합니다. 질문하면 출처까지 클릭 한 번에 추적.',
      cta: 'MindSync 열기',
      sub: 'Cotext 워크스페이스가 지식풀이라면, MindSync는 그 위의 두번째 뇌 — 어디서든 같은 뇌에 접근합니다.',
    },
    tools: {
      title: '바로 써보기',
      desc: '로그인하면 모든 기능을 곧바로 사용할 수 있어요.',
      workspaces: { label: '워크스페이스', desc: 'GitHub repo를 지식풀로 연결하고 채팅하듯 메모', tag: 'Phase 1·2' },
      studio: { label: 'MindSync', desc: '파일을 한 번에 업로드하면 AI가 지식 그래프를 자동 추출', tag: 'Phase 3·4' },
      think: { label: 'Think 모드', desc: '지식망에 질문하면 출처까지 추적하는 근거 기반 답변', tag: 'Phase 5' },
    },
    heroH1a: '당신의 지식을 항상',
    heroH1b: '팀과 에이전트와 연결하세요',
    heroSub:
      '채팅하듯 메모하세요. 언제 어디서든 당신의 지식이 동기화됩니다.',
    githubStart: 'GitHub로 시작',
    downloadApp: '안드로이드 앱 다운로드',
    heroNote: '무료로 시작 · GitHub에 동기화 · 당신의 데이터는 당신의 것',
    trustLabel: '함께 쓰는 도구',
    f1Title: '채팅하듯이, 메모하듯이',
    f1Desc: '평소에 나에게 보내는 메시지 대신 쓰다가, Markdown 에디터로 깔끔하게 정리. 모드를 바꾸는 게 아니라, 하나의 입력창이 생각의 크기에 맞춰 자랍니다.',
    f1l1a: '앱에서는 채팅처럼, 웹에서는 옵시디언처럼',
    f1l2b: ' 슬래시 커맨드로 구조화',
    f1l3: 'Enter 전송 · Shift+Enter 줄바꿈 · 한글 IME 안전',
    f2Title: 'GitHub 네이티브 공유 지식망',
    f2DescA: 'Cotext는 또 하나의 노트앱이 아닙니다. 모든 노트앱을 연결하는, 언제나 동기화되는 GitHub 네이티브 공유 지식망입니다. 디렉토리를 채팅방처럼 열면 그 안에 ',
    f2DescB: '가 생기고, 메모는 버전관리되는 Markdown으로 쌓입니다.',
    f2l1: '어디서든 접속 · 자동 동기화',
    f2l2: '모든 변경이 버전관리 — 히스토리가 사라지지 않습니다',
    f2l3: '팀원 초대 한 번으로 같은 지식망을 공유',
    f3Title: '에이전트가 이해하는 구조로 — 입력하는 순간부터',
    f3DescA: 'Cotext에 기록되는 모든 데이터는 사람이, 그리고 AI 에이전트가 가장 읽기 쉬운 형태로 기록됩니다. 구조화된 지식망은 멀티 LLM에 그대로 연결하여 단절된 컨텍스트가 아닌 공유된 지식망을 형성합니다. 골라 묶으면 그대로 ',
    f3DescB: '이 됩니다.',
    f3l1: '사람이 쓴 것과 AI가 쓴 것을 출처 태그로 구분',
    f3l2: '필요한 지식만 골라서 Context Pack으로 내보내기',
    f3l3: 'MCP + REST API — ChatGPT, Claude, Cursor 등 어디서든 연결',
    gridKicker: '흘러가는 지식을 잡아두세요',
    gridTitle: '어디서든 가볍고 빠르게',
    g1t: '지식 그래프', g1d: '기록이 쌓이면 AI가 자동으로 연결고리를 만듭니다. 흩어진 메모가 살아있는 지식망이 됩니다.',
    g2t: '에이전트 상시 연결', g2d: 'AI 에이전트가 상시로 지식을 정리하고 보강합니다. 질문하면 출처까지 추적하는 근거 기반 답변.',
    g3t: '앱 · 웹 연동', g3d: '앱에서는 채팅처럼 빠르게, 웹에서는 옵시디언처럼 깊게. 어디서 쓰든 같은 지식이 동기화됩니다.',
    g4t: '멀티 LLM 연결', g4d: '하나의 지식풀을 ChatGPT, Claude, Gemini, Cursor 어디서든 연결. 설정은 원클릭 자동 생성.',
    howKicker: '3단계',
    howTitle: '연결하고, 적고, 동기화하다',
    s1t: 'GitHub 연결', s1d: 'repo를 지식풀로 연결하거나 새로 만듭니다. 디렉토리를 채팅방처럼 열어보세요.',
    s2t: '평소처럼 메모', s2d: '텍스트, 이미지, 파일을 남기면 자동으로 정리되어 쌓입니다.',
    s3t: '어디서든 동기화', s3d: '팀원을 초대하거나 AI를 연결하세요. 같은 지식풀에 모두가 접근합니다.',
    ctaTitle: '흩어진 지식을 연결하세요',
    ctaDesc: '당신과, 팀과, 에이전트를 위한 단 하나의 공유 지식풀.',
    ctaBtn: 'Launch Cotext',
    footerCopy: '© 2026 Cotext · 당신과 팀과 에이전트를 위한 공유 지식풀',
  ...
  en: {
    ...
    mindsync: {
      ...
      desc: 'Drop Word, PPT, PDF files — AI auto-generates a semantic knowledge graph. Ask a question, and trace every answer back to its source in one click.',
      cta: 'Open MindSync',
      sub: 'If a Cotext workspace is the knowledge pool, MindSync is the second brain layer above — the same brain, reachable from anywhere.',
    },
    tools: {
      title: 'Try it now',
      desc: 'After login, every feature is one click away.',
      workspaces: { label: 'Workspaces', desc: 'Connect a GitHub repo as your knowledge pool and capture notes like chat', tag: 'Phase 1·2' },
      studio: { label: 'MindSync', desc: 'Upload docs at once — AI extracts a knowledge graph automatically', tag: 'Phase 3·4' },
      think: { label: 'Think mode', desc: 'Ask the knowledge graph and get grounded answers with source tracking', tag: 'Phase 5' },
    },
    heroH1a: 'Sync your knowledge with',
    heroH1b: 'your team and agents',
    heroSub:
      'Capture notes like chatting. Your knowledge stays in sync — anywhere, anytime.',
    githubStart: 'Start with GitHub',
    downloadApp: 'Download Android App',
    heroNote: 'Free to start · Synced to GitHub · Your data stays yours',
    trustLabel: 'Works with',
    f1Title: 'Like chatting, like note-taking',
    f1Desc: 'Use it like sending a message to yourself, then switch to a Markdown editor to polish. No mode switch — one input that grows with your thinking.',
    f1l1a: 'On the app, like chatting. On the web, like Obsidian',
    f1l2b: ' slash commands to structure',
    f1l3: 'Enter to send · Shift+Enter newline · Korean IME-safe',
    f2Title: 'A GitHub-native shared knowledge network',
    f2DescA: "Cotext isn't just another note app. It's a GitHub-native shared knowledge network that connects all your note apps — always in sync. Open a directory like a chat room and a ",
    f2DescB: ' appears inside — your notes accumulate as version-controlled Markdown.',
    f2l1: 'Access anywhere · auto sync',
    f2l2: 'Every change is version-controlled — history never disappears',
    f2l3: 'Invite a teammate and share the same knowledge network instantly',
    f3Title: 'Structured for agents — from the moment you type',
    f3DescA: 'Everything recorded in Cotext is stored in the most readable format for both humans and AI agents. Your structured knowledge network connects directly to multi-LLM workflows — forming a shared knowledge graph instead of siloed context. Bundle what you need into a ',
    f3DescB: ' and feed it to any LLM.',
    f3l1: 'Source tags distinguish human vs AI authorship',
    f3l2: 'Pick the knowledge you need and export as a Context Pack',
    f3l3: 'MCP + REST API — connect ChatGPT, Claude, Cursor, and more',
    gridKicker: 'Capture knowledge before it slips away',
    gridTitle: 'Light, fast, everywhere',
    g1t: 'Knowledge graph', g1d: 'As notes accumulate, AI automatically connects the dots. Scattered memos become a living knowledge network.',
    g2t: 'Always-on agents', g2d: 'AI agents continuously organize and enrich your knowledge. Ask a question and get grounded answers with source tracking.',
    g3t: 'App · Web in sync', g3d: 'On the app, capture like chatting. On the web, go deep like Obsidian. Same knowledge, always in sync.',
    g4t: 'Multi-LLM connect', g4d: 'Connect one knowledge pool to ChatGPT, Claude, Gemini, Cursor — anywhere. One-click auto config.',
    howKicker: 'Three steps',
    howTitle: 'Connect, capture, sync',
    s1t: 'Connect GitHub', s1d: 'Link a repo as your knowledge pool or create one. Open a directory like a chat room.',
    s2t: 'Capture naturally', s2d: 'Drop text, images, and files — they auto-organize as they stack up.',
    s3t: 'Sync everywhere', s3d: 'Invite teammates or connect AI. Everyone accesses the same knowledge pool.',
    ctaTitle: 'Connect your scattered knowledge',
    ctaDesc: 'One shared knowledge pool for you, your team, and your agents.',
    ctaBtn: 'Launch Cotext',
    footerCopy: '© 2026 Cotext · One shared knowledge pool for you, your team & agents',
    ...
    <div className="landing">
      ...
      <section className="lp-trust lp-inner">
        ...
        <div className="lp-trust-row">
          {['GitHub', 'MindSync', 'Claude', 'Cursor', 'ChatGPT', 'Grok', 'Gemini'].map((n) => (
